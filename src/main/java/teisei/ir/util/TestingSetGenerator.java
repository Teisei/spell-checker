 ...
 */
public class TestingSetGenerator {
	...
	public TestingSetGenerator(Map<String, Integer> trainingSet) {
		this.trainingSet = trainingSet;
	}

	public static Iterator<String> getTestErrors(GeneralType.TestType type) {
	...
	public static ImmutableMap<String, String> createTest1Map() {
	...
	public static ImmutableMap<String, String> createTest2Map() {
		Map<String, String> buildMap = new HashMap<String, String>();
